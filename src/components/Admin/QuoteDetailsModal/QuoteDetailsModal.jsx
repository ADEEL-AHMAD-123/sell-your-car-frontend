...
  const images = quote?.manualDetails?.images || [];
  useEffect(() => {
...
  // Destructure from the updated schema, including manualDetails
  const {
    vehicleRegistration,
    otherVehicleData,
    user,
...
          {/* User Submitted Info - Updated to get from manualDetails */}
