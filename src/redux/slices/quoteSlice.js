...
/**
 * ❌ Client rejects quote with reason
 * Backend route: PATCH /api/quote/:id/reject
 */
export const rejectQuote = createApiAsyncThunk({
  name: "rejectQuote",
  method: "PATCH",
  url: ({ id }) => `/api/quote/${id}/reject`,
  typePrefix: "rejectQuote",
  prepareHeaders: true,
});
